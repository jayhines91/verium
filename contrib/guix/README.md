# Bootstrappable Verium Builds

This directory contains the files necessary to perform bootstrappable Verium builds.
...
- 24GB of free disk space on the partition that the Verium git repository
  resides in
...
For a Verium depends development environment, simply invoke
...
From the top of a clean Verium repository:
...
To use dongcarl's substitute server for Verium builds after having
